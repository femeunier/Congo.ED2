...
suffix <- "Amazon"
scenarios <- c("S2")
prefix <- paste0("XGB.fit.ERA5.IFL",suffix,".")
GridSuffix = ".ERA5"
...
dumb <- write_bash_submission(file = file.path(getwd(),"All.fits.XGB.ILF.ERA5.sh"),
                              list_files = list_dir,
                              job_name = jobname)

# scp /home/femeunier/Documents/projects/Congo.ED2/scripts/submit.all.fits.coordlist.ERA5.R hpc:/kyukon/data/gent/vo/000/gvo00074/felicien/R/
