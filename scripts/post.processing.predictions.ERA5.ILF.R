...
for (cmodel in models){
  ...
  print(cmodel)
  cfile <- paste0("./outputs/predictions.XGB.",cmodel,".ERA5.IFLAmazon.RDS")
  cfile2 <- paste0("./outputs/predictions.XGB.test.",cmodel,".ERA5.IFLAmazon.RDS")
...
#
#   print(cmodel)
#   cfile <- paste0("./outputs/predictions.XGB.",cmodel,".ERA5.IFLCongo.RDS")
#
#   if (!file.exists(cfile)){
#     next()
#   }
...
saveRDS(df.all.ts,"./outputs/df.all.ts.ERA5.IFL.RDS")
saveRDS(df.all.year,"./outputs/df.all.year.ERA5.IFL.RDS")
saveRDS(MEM,"./outputs/df.all.ts.MEM.ERA5.IFL.RDS")
saveRDS(MEM.year,"./outputs/df.all.year.MEM.ERA5.IFL.RDS")
saveRDS(predictions.Amazon,"./outputs/Amazon.mean.ERA5.IFL.RDS")
saveRDS(predictions.Amazon.test,"./outputs/Amazon.mean.test.ERA5.IFL.RDS")
saveRDS(predictions.Congo,"./outputs/Congo.mean.ERA5.IFL.RDS")
saveRDS(predictions.Amazon.sum,"./outputs/Amazon.mean.ERA5.IFL.sum.RDS")
saveRDS(predictions.Congo.sum,"./outputs/Congo.mean.ERA5.IFL.sum.RDS")
saveRDS(Amazon,"./outputs/Amazon.ERA5.IFL.RDS")

# scp /home/femeunier/Documents/projects/Congo.ED2/scripts/post.processing.predictions.ERA5.ILF.R hpc:/data/gent/vo/000/gvo00074/felicien/R/
