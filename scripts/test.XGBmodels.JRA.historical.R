...
for (cmodel in models){
  ...
  inputs <- climate %>%
    ...
    mutate(xgb.model = paste0("XGB.fit.JRA.historical.",model,".S2.",continent,".",biome)) %>%
  ...
  saveRDS(df.all,
          paste0("./outputs/predictions.XGB.",cmodel,".JRA.historical.RDS"))
}
...
#
#
# scp /home/femeunier/Documents/projects/Congo.ED2/scripts/test.XGBmodels.JRA.historical.R hpc:/data/gent/vo/000/gvo00074/felicien/R/
