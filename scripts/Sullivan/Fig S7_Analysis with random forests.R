...
rf<-randomForest(log(AGB)~Min.temp+bio5+wind+bio17+Cloud+Clay+CEC+MEM1+MEM2+MEM3+MEM4+MEM5+MEM6+MEM7+MEM8,data=dat,weights=WtAGB,na.action=na.fail)

importance(rf) # bio17 (precip in driest quarter) and bio5 (maxT in warmest month) most important (excluding MEMs)
