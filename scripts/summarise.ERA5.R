...
init.years <- seq(2020,2023,1)

WD <- "/data/gent/vo/000/gvo00074/ED_common_data/met/Amazon/"
...
for (iyear in seq(1,length(init.years))){
  ...
  cfile <- file.path(WD,paste0("ERA5_Amazon_",init.years[iyear],".nc"))
...
saveRDS(df.ERA5,"./outputs/df.ERA5.RDS")

# scp /home/femeunier/Documents/projects/Congo.ED2/scripts/summarise.ERA5.R hpc:/kyukon/data/gent/vo/000/gvo00074/felicien/R
