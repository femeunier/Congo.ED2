...
suffix <- "Congo"
scenarios <- c("S2")
prefix <- paste0("XGB.fit.JRA.historical.IFL",suffix,".")
...
# scp /home/femeunier/Documents/projects/Congo.ED2/scripts/submit.all.fits.coordlist.R hpc:/kyukon/data/gent/vo/000/gvo00074/felicien/R/
