  ...
  for (cmonth in seq(11,12)){
    ...
    for (cday in seq(1,Ndays)){
      ...
      for (chour in c("00","06","12","18")){
        ...
        system2("wget",
                c("-N",
                  paste0("https://data.rda.ucar.edu/ds628.8/fcst_surf/",cyearmonth,"/fcst_surf.",ctime)))
        system2("mv",
                c(paste0("fcst_surf.",
                         ctime),
...
# scp /home/femeunier/Documents/projects/Congo.ED2/scripts/download.and.convert.JRAsubmonthly.R hpc:/data/gent/vo/000/gvo00074/felicien/R/
