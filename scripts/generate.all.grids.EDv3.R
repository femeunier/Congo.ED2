...
for (cmodel in models){
  ...
  model.file <- paste0("./outputs/Trendy.",cmodel,".S2.pantropical.v12.RDS")
  print(cmodel)

  if (!file.exists(model.file)){
    model.file <- paste0("./outputs/Trendy.",cmodel,".S2.CC.pantropical.v12.RDS")
  }

  if (!file.exists(model.file)) next()

  OPfile <- paste0("./data/grid.",cmodel,".pantropical.RDS")
...
# scp /home/femeunier/Documents/projects/Congo.ED2/scripts/generate.all.grids.EDv3.R hpc:/data/gent/vo/000/gvo00074/felicien/R/
