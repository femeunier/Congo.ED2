...
Tropics.sum <- readRDS("./outputs/monthly.climate.pantropical.JRA.historical.RDS")
...
for (cmodel in models){
  ...
  OPfile <- paste0("./data/grid.",cmodel,".JRA.historical.RDS")
...
# scp /home/femeunier/Documents/projects/Congo.ED2/scripts/generate.all.grids.JRA.historical.R hpc:/data/gent/vo/000/gvo00074/felicien/R/
