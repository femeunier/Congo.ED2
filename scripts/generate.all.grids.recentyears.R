...
Tropics.sum <- readRDS("./outputs/monthly.climate.pantropical.predictions.RDS")
...
for (cmodel in models){
  ...
  OPfile <- paste0("./data/grid.",cmodel,".recentyears.RDS")
...
# scp /home/femeunier/Documents/projects/Congo.ED2/scripts/generate.all.grids.recentyears.R hpc:/data/gent/vo/000/gvo00074/felicien/R/
