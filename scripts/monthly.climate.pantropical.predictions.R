...
# saveRDS(df.all.monthly,
#         paste0("./outputs/monthly.climate.pantropical.predictions",".RDS"))

# scp /home/femeunier/Documents/projects/Congo.ED2/scripts/monthly.climate.pantropical.predictions.R hpc:/data/gent/vo/000/gvo00074/felicien/R/
