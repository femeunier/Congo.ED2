    ...
    for (year in years){
      for (imonth in seq(1,12)){
        ...
        h5file <- file.path(dirname(files.names)[1],
                            paste("analysis","E",as.character(year),sprintf("%02d",imonth),"00-000000-g01.h5",sep = "-"))
...
# scp /home/femeunier/Documents/projects/Congo.ED2/scripts/analyze_CB_Efiles.R hpc:/data/gent/vo/000/gvo00074/felicien/R
